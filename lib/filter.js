...
const getServicesByRegionAndFilter = sortBy => `*[_type == "supportService" && references(^._id) && references(*[_type=="region" && name==$chosenRegion]._id) && references(*[_type=="region" && name==$chosenRegion]._id)] | order(${sortBy}) { 
  name, 
  "logo": logo.asset->url,
  "tags": tags[]->title,
...
export { getCategoryServicePreview, GET_FILTER_TYPES, GET_REGIONS, getSortBy }
